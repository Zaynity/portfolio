...
image:
  {
    url: "/portfolio/skills/docker/docker.gif",
    alt: "Docker",
  }
tags: ["FinalView"]
category: "technical"
...
À moyen terme, je souhaite en apprendre davantage sur Kubernetes, l’orchestrateur le plus utilisé en entreprise pour la gestion d’applications conteneurisées. La maîtrise de Kubernetes me permettrait de gérer efficacement des clusters de conteneurs Docker. Pour y parvenir, je prévois de suivre une formation sur « [Apprendre les bases de Kubernetes](https://kubernetes.io/fr/docs/tutorials/kubernetes-basics/) » de Kubernetes afin d'apprendre à configurer, déployer et maintenir des applications multi-conteneurs dans un cluster, ainsi qu'à automatiser les déploiements en reproduisant des environnements types de développement et de production par exemple.
