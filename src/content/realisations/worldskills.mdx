...
<img src="/portfolio/production/worldskills/worldskills.png" alt="Podium" width="500" height="auto" style="border-radius: 8px;"/>
...
L’enjeu était important, car je me trouve à un tournant dans mon parcours.
...
<img src="/portfolio/production/worldskills/during_competition.png" alt="Pendant la compétition" width="500" height="auto" style="border-radius: 8px;"/>
Une fois connecté, j’ai exploré la documentation pour trouver où configurer les règles données dans le sujet, comme le filtrage des adresses IP et les blocages de certains sites web comme Facebook par exemple.

Grâce à une **bonne répartition des tâches** et une coordination presque parfaite, j’ai pu rendre avec Benoît des livrables qui nous ont permis de gagner la compétition.
...
<img src="/portfolio/production/worldskills/gold_medal.png" alt="Médaille" width="200" height="auto" style="border-radius: 8px;"/>
